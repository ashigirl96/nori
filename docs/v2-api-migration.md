...
- use a v2 JSON client (`tests_v2/nori.py`)
- avoid depending on v1 text output formats

VM runners:
- v1: `ssh nori-vm 'cd /Users/nori/GhosttyTabs && ./scripts/run-tests-v1.sh'`
- v2: `ssh nori-vm 'cd /Users/nori/GhosttyTabs && ./scripts/run-tests-v2.sh'`
