...
```bash
nori browser surface:7 snapshot
nori browser surface:7 snapshot --interactive
nori browser surface:7 snapshot --interactive --compact --max-depth 3
```

## Using Refs

```bash
nori browser surface:7 click e6
nori browser surface:7 fill e10 "user@example.com"
nori browser surface:7 fill e11 "password123"
nori browser surface:7 click e12
```
...
nori browser surface:7 click e1
...
```bash
nori browser surface:7 wait --selector "#target" --timeout-ms 10000
nori browser surface:7 scroll --dy 400
nori browser surface:7 snapshot --interactive
```
...
```bash
nori browser surface:7 snapshot --selector "form#checkout" --interactive
```
