...
def _find_cli_binary() -> str:
    ...
    fixed = os.path.expanduser(
        "~/Library/Developer/Xcode/DerivedData/nori-tests-v2/Build/Products/Debug/nori"
    )
...
<!doctype html>
<html>
  <head><title>nori-browser-cli-regression</title></head>
  <body>
    <main>
...
""".strip()
        ...
        out_dir = Path(tempfile.mkdtemp(prefix="nori-browser-screenshot-cli-")) / "nested" / "dir"
