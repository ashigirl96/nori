...
def test_goto_split_from_loaded_browser(client: nori) -> tuple[bool, str]:
    """
...
def test_goto_split_roundtrip_loaded_browser(client: nori) -> tuple[bool, str]:
    """
...
def run_tests() -> int:
    print("=" * 60)
    print("nori Browser goto_split Regression Test")
    print("=" * 60)
    print()
    ...
    try:
        with nori(socket_path=socket_path) as client:
