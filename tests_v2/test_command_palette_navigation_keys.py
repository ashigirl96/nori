...
def _open_palette_with_query(client: nori, window_id: str, query: str) -> None:
...
def _assert_move(client: nori, window_id: str, combo: str, start_index: int, expected_index: int) -> None:
...
def _assert_can_navigate_past_ten_results(client: nori, window_id: str) -> None:
