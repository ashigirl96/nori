...
final class BrowserPaneNavigationKeybindUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        dataPath = "/tmp/nori-ui-test-goto-split-\(UUID().uuidString).json"
    ...
    func testCmdCtrlHMovesLeftWhenWebViewFocused() {
        ...
        app.launchEnvironment["NORI_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        app.launchEnvironment["NORI_UI_TEST_FOCUS_SHORTCUTS"] = "1"
    ...
    func testCmdCtrlHMovesLeftWhenWebViewFocusedUsingGhosttyConfigKeybind() {
        ...
        app.launchEnvironment["NORI_UI_TEST_FOCUS_SHORTCUTS"] = "1"
        app.launchEnvironment["NORI_SOCKET_PATH"] = socketPath
        app.launchEnvironment["NORI_UI_TEST_GOTO_SPLIT_USE_GHOSTTY_CONFIG"] = "1"
        launchAndEnsureForeground(app)
    ...
    func testEscapeRestoresFocusedPageInputAfterCmdL() {
        ...
        app.launchEnvironment["NORI_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        app.launchEnvironment["NORI_UI_TEST_FOCUS_SHORTCUTS"] = "1"
        app.launchEnvironment["NORI_UI_TEST_GOTO_SPLIT_INPUT_SETUP"] = "1"
        launchAndEnsureForeground(app)
    ...
    func testCmdFFocusesBrowserFindFieldAfterCmdDCmdLNavigation() {
        let app = XCUIApplication()
        app.launchEnvironment["NORI_SOCKET_PATH"] = socketPath
        app.launchEnvironment["NORI_UI_TEST_GOTO_SPLIT_RECORD_ONLY"] = "1"
        app.launchEnvironment["NORI_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        launchAndEnsureForeground(app)
