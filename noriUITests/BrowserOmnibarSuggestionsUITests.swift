...
final class BrowserOmnibarSuggestionsUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        dataPath = "/tmp/nori-ui-test-omnibar-suggestions-\(UUID().uuidString).json"
    ...
    func testOmnibarSuggestionsAlignToPillAndCmdNP() {
        ...
        app.launchEnvironment["NORI_UI_TEST_DISABLE_REMOTE_SUGGESTIONS"] = "1"
    ...
    func testOmnibarSuggestionsCmdNPWhenAddressBarFocused() {
        ...
        app.launchEnvironment["NORI_UI_TEST_GOTO_SPLIT_PATH"] = dataPath
        app.launchEnvironment["NORI_UI_TEST_DISABLE_REMOTE_SUGGESTIONS"] = "1"
        app.launchEnvironment["NORI_UI_TEST_REMOTE_SUGGESTIONS_JSON"] = #"["go tutorial","go json","go fmt"]"#
        launchAndEnsureForeground(app)
    ...
    private func seedBrowserHistoryForTest(entries: [(String, String)]? = nil, seedEntries: [SeedEntry]? = nil) {
        ...
        let bundleId = "com.nori.app.debug"
