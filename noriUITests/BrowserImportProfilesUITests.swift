...
final class BrowserImportProfilesUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        capturePath = "/tmp/nori-ui-test-browser-import-\(UUID().uuidString).json"
    ...
    private func launchApp() -> XCUIApplication {
        ...
        app.launchEnvironment["NORI_UI_TEST_BROWSER_IMPORT_FIXTURE"] = #"{"browserName":"Helium","profiles":["You","austin"]}"#
        app.launchEnvironment["NORI_UI_TEST_BROWSER_IMPORT_DESTINATIONS"] = #"["Default"]"#
        app.launchEnvironment["NORI_UI_TEST_BROWSER_IMPORT_MODE"] = "capture-only"
        app.launchEnvironment["NORI_UI_TEST_BROWSER_IMPORT_CAPTURE_PATH"] = capturePath
        app.launchEnvironment["NORI_UI_TEST_BROWSER_IMPORT_HINT_VARIANT"] = "inlineStrip"
        app.launchEnvironment["NORI_UI_TEST_BROWSER_IMPORT_HINT_SHOW"] = "1"
        app.launchEnvironment["NORI_UI_TEST_BROWSER_IMPORT_HINT_DISMISSED"] = "0"
        app.launchEnvironment["NORI_UI_TEST_BROWSER_IMPORT_HINT_OPEN_BLANK_BROWSER"] = "1"
