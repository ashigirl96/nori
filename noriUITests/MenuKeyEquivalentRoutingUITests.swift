...
final class MenuKeyEquivalentRoutingUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        gotoSplitPath = "/tmp/nori-ui-test-goto-split-\(UUID().uuidString).json"
        keyequivPath = "/tmp/nori-ui-test-keyequiv-\(UUID().uuidString).json"
    ...
    func testCmdFFirstLetsWebContentHandleFindShortcut() {
        ...
        XCTAssertTrue(
            ...
            "Expected Cmd+F to reach browser content before nori find overlay. data=\(loadGotoSplit() ?? [:])"
        )
    }
    ...
    func testVisibleBrowserFindBarKeepsCmdGAndCmdShiftFOwnedByNori() {
        ...
        XCTAssertTrue(
            ...
            "Expected nori browser find bar to open and capture the query before page-focus checks. data=\(loadGotoSplit() ?? [:])"
        )
        ...
        XCTAssertTrue(
            ...
            "Expected visible nori browser find bar to keep Cmd+G ownership after page refocus. data=\(loadGotoSplit() ?? [:])"
        )
        ...
        XCTAssertTrue(
            ...
            "Expected visible nori browser find bar to keep Cmd+Shift+F ownership after page refocus. data=\(loadGotoSplit() ?? [:])"
        )
    }
    ...
    private func launchWithBrowserSetup(browserURL: String? = nil) -> XCUIApplication {
        ...
        app.launchEnvironment["NORI_UI_TEST_GOTO_SPLIT_SETUP"] = "1"
        app.launchEnvironment["NORI_UI_TEST_GOTO_SPLIT_PATH"] = gotoSplitPath
        app.launchEnvironment["NORI_UI_TEST_KEYEQUIV_PATH"] = keyequivPath
        if let browserURL {
            app.launchEnvironment["NORI_UI_TEST_GOTO_SPLIT_BROWSER_URL"] = browserURL
        }
        app.launch()
        app.activate()
...
final class SplitCloseRightBlankRegressionUITests: XCTestCase {
    ...
    override func setUp() {
        ...
        dataPath = "/tmp/nori-ui-test-split-close-right-\(UUID().uuidString).json"
        socketPath = "/tmp/nori-ui-test-socket-\(UUID().uuidString).sock"
        diagnosticsPath = "/tmp/nori-ui-test-diagnostics-\(UUID().uuidString).json"
        ...
        let leaf = "nori-ui-test-split-close-right-shots-\(UUID().uuidString)"
    ...
    func testClosingBothRightSplitsDoesNotLeaveBlankPane() {
        let app = XCUIApplication()
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_SETUP"] = "1"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_PATH"] = dataPath
        app.launchEnvironment["NORI_SOCKET_PATH"] = socketPath
        app.launchEnvironment["NORI_UI_TEST_DIAGNOSTICS_PATH"] = diagnosticsPath
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingRightSplitsViaShortcuts() {
        ...
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_SETUP"] = "1"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_PATH"] = dataPath
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_VISUAL"] = "1"
        // The regression can be a single compositor frame; capture enough post-close frames to
        // deterministically catch it.
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_ITERATIONS"] = "12"
        // Close quickly (closer to how a user can click two close buttons back-to-back).
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "0"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "32"
        // Repro order that still flashes for users: split left/right first, then split top/down.
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_lrtd"
        app.launch()
        app.activate()
    ...
    func testReproStretchAfterClosingSingleRightSplit() {
        ...
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_PATH"] = dataPath
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_VISUAL"] = "1"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_ITERATIONS"] = "16"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "0"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "36"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_single"
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingBottomSplitsViaShortcuts() {
        ...
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "0"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "32"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_bottom"
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingRightSplitsTopFirstWithGap() {
        ...
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_PATH"] = dataPath
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_VISUAL"] = "1"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_ITERATIONS"] = "14"
        // Reproduce manual close cadence: close top-right, observe one frame, then close bottom-right.
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "120"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "40"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_lrtd"
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingRightSplitsBottomFirstViaShortcuts() {
        ...
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "120"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "40"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_lrtd_bottom_first"
        app.launch()
        app.activate()
    ...
    func testReproBlankAfterClosingRightSplitsWithoutFocusingRightPanes() {
        ...
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_CLOSE_DELAY_MS"] = "0"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_BURST_FRAMES"] = "36"
        app.launchEnvironment["NORI_UI_TEST_SPLIT_CLOSE_RIGHT_PATTERN"] = "close_right_lrtd_unfocused"
        app.launch()
        app.activate()
    ...
    private func assertPaneRendersAndUpdates(
        ...
        app.typeText("yes NORI_AFTER_CLOSE_\(label)_\(token) | head -n 30\n")
