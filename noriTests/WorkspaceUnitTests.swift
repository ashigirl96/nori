...
final class KeyboardShortcutSettingsFileStoreTests: XCTestCase {
    ...
    private let settingsFileBackupsDefaultsKey = "nori.settingsFile.backups.v1"
    ...
    func testBootstrapCreatesCommentedTemplateWhenPrimaryAndFallbackAreMissing() throws {
        ...
        let settingsFileURL = directoryURL
            .appendingPathComponent(".config/nori", isDirectory: true)
    ...
    func testSettingsFileStoreParsesJSONCCommentsAndTrailingCommas() throws {
        ...
        try writeSettingsFile(
            """
            {
              "$schema": "https://raw.githubusercontent.com/manaflow-ai/nori/main/web/data/nori-settings.schema.json",
              "schemaVersion": 1,
              // tmux-like prefix
              "shortcuts": {
                "bindings": {
...
final class WorkspaceCreationConfigSanitizationTests: XCTestCase {
    private final class UnsafeConfigSnapshotWorkspaceManager: WorkspaceManager {
        ...
        func installInjectedConfig(fontSize: Float) {
            ...
            config.workingDirectory = "/tmp/nori-workspace-snapshot"
            config.command = "echo snapshot"
            config.environmentVariables = ["NORI_INHERITED_ENV": "1"]
...
final class WorkspaceSplitWorkingDirectoryTests: XCTestCase {
    ...
    func testNewTerminalSplitFallsBackToRequestedWorkingDirectoryWhenReportedDirectoryIsStale() {
        ...
        let requestedDirectory = "/tmp/nori-requested-split-cwd-\(UUID().uuidString)"
...
final class WorkspacePanelGitBranchTests: XCTestCase {
    ...
    func testUpdatingFocusedPanelPullRequestWithSameStateDoesNotRepublishWorkspace() {
        ...
        let pullRequestURL = URL(string: "https://github.com/manaflow-ai/nori/pull/2388")!
    ...
    func testSidebarPullRequestsTrackFocusedPanelOnly() {
        ...
        workspace.updatePanelPullRequest(
            ...
            number: 1629,
            label: "PR",
            url: URL(string: "https://github.com/manaflow-ai/nori/pull/1629")!,
            status: .open
        )
    ...
    func testSidebarDerivedCollectionsMatchWhenUsingPrecomputedPanelOrder() {
        ...
        workspace.updatePanelPullRequest(
            ...
            number: 101,
            label: "PR",
            url: URL(string: "https://github.com/manaflow-ai/nori/pull/101")!,
            status: .open
        )
        workspace.updatePanelPullRequest(
            ...
            number: 18,
            label: "MR",
            url: URL(string: "https://gitlab.com/manaflow/nori/-/merge_requests/18")!,
            status: .merged
        )
