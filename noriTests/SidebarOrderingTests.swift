...
final class SidebarBranchOrderingTests: XCTestCase {
        ...
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            ...
            panelPullRequests: [
                first: pullRequestState(
                    number: 337,
                    label: "PR",
                    url: "https://github.com/manaflow-ai/nori/pull/337",
                    status: .open
                ),
                second: pullRequestState(
                    number: 18,
                    label: "MR",
                    url: "https://gitlab.com/manaflow/nori/-/merge_requests/18",
                    status: .open
                ),
                ...
                fourth: pullRequestState(
                    number: 92,
                    label: "PR",
                    url: "https://bitbucket.org/manaflow/nori/pull-requests/92",
                    status: .closed
                )
            ],
        ...
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            ...
            panelPullRequests: [
                first: pullRequestState(
                    number: 42,
                    label: "PR",
                    url: "https://github.com/manaflow-ai/nori/pull/42",
                    status: .open,
                    isStale: true
                ),
                second: pullRequestState(
                    number: 42,
                    label: "MR",
                    url: "https://gitlab.com/manaflow/nori/-/merge_requests/42",
                    status: .open
                )
            ],
    ...
    func testOrderedUniquePullRequestsTreatsSameNumberAndLabelDifferentUrlsAsDistinct() {
        ...
        XCTAssertEqual(
            ...
            [
                "https://github.com/manaflow-ai/nori/pull/42",
    ...
    func testUpdatePanelPullRequestClearsStaleFlagOnFreshUpdate() {
        ...
        workspace.updatePanelPullRequest(
            ...
            number: 42,
            label: "PR",
            url: URL(string: "https://github.com/manaflow-ai/nori/pull/42")!,
            status: .open,
            isStale: true
        )
        workspace.updatePanelPullRequest(
    ...
    func testOrderedUniquePullRequestsUsesFallbackWhenNoPanelPullRequestsExist() {
        let fallback = pullRequestState(
            number: 11,
            label: "PR",
            url: "https://github.com/manaflow-ai/nori/pull/11",
            status: .open
        )
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            orderedPanelIds: [],
...
final class TerminalControllerSidebarDedupeTests: XCTestCase {
    ...
    func testShouldReplacePullRequestReturnsTrueWhenCurrentStateIsStale() throws {
        let url = try XCTUnwrap(URL(string: "https://github.com/manaflow-ai/nori/pull/42"))
    ...
    func testNormalizeReportedDirectoryTrimsWhitespace() {
        XCTAssertEqual(
            TerminalController.normalizeReportedDirectory("   /Users/nori/project   "),
            "/Users/nori/project"
        )
    }
    ...
    func testNormalizeReportedDirectoryResolvesFileURL() {
        XCTAssertEqual(
            TerminalController.normalizeReportedDirectory("file:///Users/nori/project"),
            "/Users/nori/project"
        )
    }
