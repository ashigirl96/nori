...
def verify_views_in_window(client: nori, label: str = "", timeout: float = 8.0) -> Optional[str]:
...
def _close_and_verify(client: nori, change: StateChange, close_idx: Union[int, str],
