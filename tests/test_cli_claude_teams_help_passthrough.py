#!/usr/bin/env python3
"""
Regression test: `nori claude-teams --help` passes through to Claude.
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="nori-claude-teams-help-") as td:
        tmp = Path(td)
        home = tmp / "home"
...
""",
        ...
        if proc.returncode != 0:
            print("FAIL: `nori claude-teams --help` exited non-zero")
    ...
    print("PASS: nori claude-teams forwards --help to Claude")
    return 0
