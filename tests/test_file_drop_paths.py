...
def wait_for_text(client: nori, surface_id: str, needle: str, timeout: float = 3.0) -> bool:
...
def main() -> int:
    ...
    p1 = (tmp / "nori drop [image] #1 (a).png").resolve()
    p2 = (tmp / "nori drop second & file!.jpg").resolve()
