#!/usr/bin/env python3
"""
Interactive test for Ctrl+C and Ctrl+D in nori terminal.

This script tests that control signals are properly handled.
Run this script inside the nori terminal.
...
def main():
    print("=" * 50)
    print("nori Control Signal Test")
    print("=" * 50)
    print("\nThis script tests if Ctrl+C and Ctrl+D work correctly.")
    print("Run this inside the nori terminal to verify the fix.\n")
