#!/usr/bin/env python3
"""
Regression tests for `nori __tmux-compat split-window`.
"""
...
def run_cli(
    ...
    env["NORI_WORKSPACE_ID"] = "workspace:1"
    env["NORI_SURFACE_ID"] = "surface:1"
...
def main() -> int:
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="nori-tmux-surface-ref-") as td:
            tmp = Path(td)
